...
sys_notify[000]     = "Vous devez saisir l'ID de l'entité !";
sys_notify[001]     = "Paramètres invalides, devrait être %s.";
sys_notify[002]     = "Nombre de paramètres invalide, devrait être %s.";
sys_notify[003]     = "Impossible de trouver une entité avec l'ID #%d!";
sys_notify[004]     = "Index d'option invalide, le maximum est %d.";
sys_notify[005]     = "Pas d'entité ou de modèle pour l'entité #%d!";
sys_notify[006]     = "ID de pièce incorrect : #%d!";
sys_notify[007]     = "Il n'y a pas de modèles avec l'ID #%d.";
sys_notify[008]     = "Nombre d'action incorrect.";
